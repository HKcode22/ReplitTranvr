...
# V3.9 Phase-2G / Gate-2 Stage-1 one-time overnight runner for P2G05 / LKPR.
#
# Purpose:
#   Allow the already-approved LKPR Stage-1 attempt to launch inside the frozen
...
EXEC_HEAD="7817671d766694f97f6c5c0296a9a0152082374a"

AUTH="AUTH-20260918-P2G05"
AUTH_FILE="SEPmd/V3.9_PHASE2G_AUTH_20260918_P2G05.json"
AUTH_SHA="cc1335e5e7e36de0566ab50cfd2a255f6ef769b27cb548e3b647f64be6f31b04"

RUNTIME_FILE="artifacts/phase2g-gate2-runtime-P2G-S1-20260918-04.json"
RUNTIME_SHA="9a7ad3c41fe61e48f15803548c345aafdff46b2e7a92e0d7159986cf34202ec8"
...
BUDGET_DAY="P2G-S1-20260918-04"

CALLBACK_PREP_UTC="2026-09-18 12:20:00 UTC"   # 05:20 PDT
PREFLIGHT_UTC="2026-09-18 12:30:05 UTC"       # 05:30:05 PDT

RUNNER_LOG="artifacts/phase2g-P2G05-overnight-runner-20260918.log"
mkdir -p artifacts
...
log "P2G05_OVERNIGHT_RUNNER_START"
...
PREFLIGHT="artifacts/phase2g-stage1-paid-preflight-P2G05-$(date -u +%Y%m%dT%H%M%SZ).json"
...
LAUNCH_OUT="artifacts/phase2g-P2G05-overnight-launch-$(date -u +%Y%m%dT%H%M%SZ).txt"
...
STATUS="$(ls -1t artifacts/phase2g-stage1-AUTH-20260918-P2G05-*.status.json 2>/dev/null | head -n1 || true)"
...
log "P2G05_OVERNIGHT_RUNNER_FINISHED"
