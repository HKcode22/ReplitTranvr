...
// Diff against server/index.ts (original) to see the server2 changes.
// ============================================================================
...
(async () => {
  ...
  httpServer.listen(
    ...
    () => {
      ...
      // [disabled 2026-08-06] v2 monitoring engine startup SHUT DOWN.
      // No more AeroDataBox polling — we are moving to AeroDataBox webhooks.
      // Kept commented out just in case; do not re-enable.
      // try {
