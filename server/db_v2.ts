...
// DISABLED 2026-08-06: v2 boot migration is SHUT DOWN (v2 tables not created).
// Reference copy only - do NOT wire this file in.
// Diff against server/db.ts (original) to see the server2 changes.
// ============================================================================
import { Pool } from "pg";
