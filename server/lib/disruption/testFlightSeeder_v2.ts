...
// DISABLED 2026-08-06: test flight seeder (API extraction) SHUT DOWN.
// Reference copy only - do NOT wire this file in.
// Diff against server/lib/disruption/testFlightSeeder.ts (original).
// ============================================================================
...
async function seedAirport(
  ...
  for (const bucket of TIME_BUCKETS) {
    ...
    for (const raw of selected) {
      ...
      // [disabled 2026-08-06] v2 insert SHUT DOWN (no more API extraction).
      // insertFlightToV2({
