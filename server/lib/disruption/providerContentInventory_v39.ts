...
export const PROVIDER_CONTENT_COLUMN_GROUPS: readonly ProviderContentColumnGroup[] = Object.freeze([
  ...
  },
  {
    ...
    note: "Provider balance observations and their external authoritative delta are cleared under the raw-provider clock; project internal-send, reconciliation and experiment metadata remain.",
  },
  {
    id: "anchor-probe-provider-account-values",
    table: "clean.adb_anchor_probe",
    columns: ["subscription_id", "balance_before", "balance_after", "credits_spent"],
    retentionClass: "raw_provider_content",
    disposition: "expiry-covered",
    owner: "providerAccountExpiry_v39",
    note: "Provider subscription identity, edge balances and the direct external balance delta are cleared under the raw-provider clock; probe yield/capacity/stability analytics remain.",
  },
  {
