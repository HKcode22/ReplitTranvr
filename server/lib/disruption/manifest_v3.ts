...
export const V39_MANIFEST:ManifestEntry[]=[
 ...
 changed("migration","migrations/0026_collection_v39_phase0_closure.sql","Phase-0 closure schema"),
 changed("migration","migrations/0027_collection_v39_phase0_runtime.sql","runtime closure schema"),
 changed("migration","migrations/0028_collection_v39_phase0_identity.sql","identity closure schema"),
 changed("migration","migrations/0029_collection_v39_phase0_snapshot.sql","snapshot closure schema"),
 changed("migration","migrations/0030_collection_v39_phase0_auth.sql","authorization closure schema"),
 changed("migration","migrations/0031_collection_v39_phase0_security.sql","security closure schema"),
