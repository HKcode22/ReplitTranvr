...
BEGIN;
ALTER TABLE clean.adb_anchor_probe ADD COLUMN IF NOT EXISTS confirmed_unique_lower INTEGER;
ALTER TABLE clean.adb_anchor_probe ADD COLUMN IF NOT EXISTS confirmed_plus_ambiguous_upper INTEGER;
ALTER TABLE clean.adb_anchor_probe ADD COLUMN IF NOT EXISTS preprobe_artifact_sha256 TEXT;
ALTER TABLE clean.adb_anchor_probe ADD COLUMN IF NOT EXISTS probe_budget_day_id TEXT;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
     WHERE conname = 'adb_anchor_probe_identity_bounds_order'
